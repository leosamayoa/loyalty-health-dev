		...
		<nav class="container navigation post-navigation">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous fs-30">%link</span>', _x( '<i class="fa fa-arrow-left"></i>&nbsp;Previous', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next fs-30">%link</span>', _x( 'Next&nbsp;<i class="fa fa-arrow-right"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
